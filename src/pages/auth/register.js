					...
					{({isSubmitting, isValid, dirty, values}) => (
						<Form className="grid gap-y-1.5">
							...
							<p className="text-xs text-[#8e8e8e] py-2">
								People who use our service may have uploaded your contact information to Instagram. <a href="#top" className="font-semibold">Learn More</a>
								<br/><br/>
								By signing up, you agree to our <a href="#" className="font-semibold">Terms</a>, <a href="#top" className="font-semibold">Data Policy</a> and <a
